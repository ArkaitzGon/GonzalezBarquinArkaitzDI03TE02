...
import { ConsultasRestService } from 'src/app/services/consultas-rest.service';
...
export class Tab1Page {
  ...
  */
  ...
  constructor(private leerArticulosFicheroHttp: HttpClient, public gestionNoticiasLeerService: GestionNoticiasLeerService,
               public noticiasRest: ConsultasRestService, public gestionNoticias: GestionStorageService) {
